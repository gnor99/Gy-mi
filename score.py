...
class Ui_ScoreWindow(object):
    ...
    def click(self, MainWindow):
        ...
        #Gomb ha triggerelödik hogy új játékot kell 

        from project import Ui_MainWindow # Ez azért kell ide mert ha globálisan implementálnánk akkor egy circular import jönne létre
    ...
    def retranslateUi(self, MainWindow):
        ...
        # itt a szövegek megjelenése van
    ...
    def scorecounter(self, d):
        ...
        #itt számolja a tárolók pontjait
    ...
    def scoreloadup(self, applestack, grapesstack, strawberrystack, peachstack, plumstack, pearstack):
        ...
        # Ez tölti fel a táblázatot a tárolók alapján


        #elöször egy dictionaryba rakja fel 
        ...
        #Majd a dictionary alapján feltölti a táblázatot
        ...
        for i in range(6):
            ...
            #Itt számolodika  végső pont a táblázat utolsó elemeiből
        ...
        #Itt állítodik át a gif a pontszám alalpján
